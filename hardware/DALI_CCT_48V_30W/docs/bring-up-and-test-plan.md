...
1. Sweep WW from minimum (0.1% = ~0.6mA target) to 600mA.
...
1. **Set bus voltage to fixed 44V** (this is the normal operating mode).
2. Run WW channel at worst-case: I_WW = 600mA with V_LED_forward ≈ 28V (use resistive dummy load: R = 40Ω / 25W connected from LED_BUS+ to WW−).
...
### Step 6.3: Thermal Camera Survey

1. Run both channels at 600mA for 30 minutes.
...
| Current accuracy | ±3% of setpoint, 1mA–600mA |
...
| OCP | Trips within 1ms at 900mA; auto-recovers after 100ms |
